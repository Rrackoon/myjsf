...
a persistence unit "myjsfPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "myjsf/pom.xml":
...
artifact ("myjsf.war") is already built. You can build
